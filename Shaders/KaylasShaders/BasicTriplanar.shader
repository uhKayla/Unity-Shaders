// Upgrade NOTE: upgraded instancing buffer 'KaylaBasicTriplanar' to new syntax.

// Made with Amplify Shader Editor
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "Kayla/Basic Triplanar"
{
	Properties
	{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(KaylaBasicTriplanar)
			UNITY_DEFINE_INSTANCED_PROP(float4, _BaseColor)
#define _BaseColor_arr KaylaBasicTriplanar
			UNITY_DEFINE_INSTANCED_PROP(float4, _EmissionColor)
#define _EmissionColor_arr KaylaBasicTriplanar
			UNITY_DEFINE_INSTANCED_PROP(float2, _TriplanarTiling)
#define _TriplanarTiling_arr KaylaBasicTriplanar
			UNITY_DEFINE_INSTANCED_PROP(float, _Smoothness)
#define _Smoothness_arr KaylaBasicTriplanar
		UNITY_INSTANCING_BUFFER_END(KaylaBasicTriplanar)
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Smoothness = ( triplanar12.w * _Smoothness_Instance );
...
/*ASEBEGIN
Version=18707
49;252;2234;652;2320.344;696.5477;1.6;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-363.5428,345.0523;Inherit;False;InstancedProperty;_Smoothness;Smoothness;3;0;Create;True;0;0;False;0;False;0;0.918;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;12;-771.4722,236.929;Inherit;True;Spherical;World;False;Metallic;_Metallic;white;2;None;Mid Texture 2;_MidTexture2;white;-1;None;Bot Texture 2;_BotTexture2;white;-1;None;Metallic;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;7;-349.072,718.5292;Inherit;False;InstancedProperty;_EmissionColor;Emission Color;6;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TriplanarNode;16;-765.1429,605.0526;Inherit;True;Spherical;World;False;Emission;_Emission;white;5;None;Mid Texture 4;_MidTexture4;white;-1;None;Bot Texture 4;_BotTexture4;white;-1;None;Emission;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TriplanarNode;8;-782.6718,-127.8712;Inherit;True;Spherical;World;False;Albedo;_Albedo;white;0;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Albedo;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-177.9426,255.4524;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;11;-771.4724,54.52895;Inherit;True;Spherical;World;True;Normal;_Normal;bump;1;None;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Normal;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=4BB82F049806357DD9E787716A68730E989B9878